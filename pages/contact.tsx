...
export default function Contact(props){
  ...
  return (
    <motion.div className="flex items-center overflow-y-scroll bg-gray-200 dark:bg-gray-500">
        <div className="container mx-auto">
            <div className="max-w-xl p-1 mx-auto my-10 rounded-md shadow-sm">
                <div className="text-center">
                    <h3 className="my-4 text-3xl font-medium tracking-wider text-yellow-500">Contactez-moi</h3>
                    ...
                    <form action="" onSubmit={sendEmail}>
                        <div className="grid grid-cols-12">
                            <div className="col-span-12 pr-2 mb-4 sm:col-span-6 lg:col-span-6">
                                <label htmlFor="nom" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">Nom</label>
                            ...
                            <div className="col-span-12 mb-4 sm:col-span-6 lg:col-span-6">
                                <label htmlFor="prenom" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">Prénom</label>
                        ...
                        <div className="mb-4">
                            <label htmlFor="sujet" className="text-sm text-gray-600 dark:text-gray-400">Sujet</label>
                            <input type="text" name="sujet" placeholder="Sujet du message" required className="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:border-gray-400 dark:focus:border-gray-400" />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="message" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">Message</label>
                        ...
                        <div className="mb-4">
                            <button className="w-full px-3 py-4 text-white bg-gradient-to-r from-yellow-500 to-red-400 dark:from-dark-500 dark:to-dark-700 dark:text-white">Envoyer le message</button>
                        </div>
