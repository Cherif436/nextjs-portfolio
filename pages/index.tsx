  ...
  return (
    <div className="">
      ...
      <motion.div className="flex flex-col flex-grow" variants={routeAnimation} initial="initial" animate="animate">  
        <h1 className="text-2xl font-bold text-center">A propos de moi</h1>
        <hr className="mb-8" />
